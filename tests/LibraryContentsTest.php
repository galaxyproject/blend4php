...
class LibraryContentsTest extends PHPUnit_Framework_TestCase {
  ...
  */
  public function testIndex($galaxy){
    $library_contents = new LibraryContents($galaxy);
    ...
    $this->assertTrue(is_array($index), $library_contents->getErrorMessage());
  ...
  */
  public function testCreate($galaxy, $return_array){
    ...
    $this->assertTrue(is_array($library_content), $library_contents->getErrorMessage());
